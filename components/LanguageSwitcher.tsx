    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Menu */}
          <div className="absolute end-0 mt-2 w-48 bg-trellis-ground border border-trellis-vine/30 rounded-lg shadow-lg shadow-trellis-vine/20 z-20 overflow-hidden">
            <div className="py-1">
              {languages.map((language) => (
                ...
                >
                  ...
                  {language.code === i18n.language && (
                    <svg className="w-4 h-4 text-trellis-clay ms-auto" fill="currentColor" viewBox="0 0 20 20">
